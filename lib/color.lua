...
if not Color then
	...
	function Color:euclid_dist2(other)
		return 2*(self.r - other.r)^2 + 
		       2*(self.g - other.g)^2 + 
			   (self.b - other.b)^2
	end
	
	-- function Color:euclid_dist2(other)
		-- local half = 1/(2*Color.ONE)
		-- local rc = 2 - (1-(self.r+other.r)*half)^3
		-- local gc = 2 - (1-(self.g+other.g)*half)^3
		-- local bc = 2 - (1-(self.b+other.b)*half)^3
		
		-- return rc*(self.r - other.r)^2 + 
		       -- gc*(self.g - other.g)^2 + 
			   -- bc*(self.b - other.b)^2
	-- end
